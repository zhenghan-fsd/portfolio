...
const Team = () => (
  <div id="team" className="team">
    <div className="container">
      <h2 className="wow fadeInUp">Team</h2>
      ...
      <div className="row">
        <div className="col-md-3 col-lg-3 wow fadeInLeft" data-wow-delay="1.8s">
        ...
        <div className="col-md-3 col-lg-3 wow fadeInLeft" data-wow-delay="1.4s">
        ...
        <div className="col-md-3 col-lg-3 wow fadeInLeft" data-wow-delay="0.4s">
